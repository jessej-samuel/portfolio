...
const Stats = ({ className = "", setCursorState }: StatsProps) => {
  ...
  return (
    <div
      ...
      className={`${className} p-5 font-medium text-black bg-gradient-to-tr from-white/80 via-40% via-geist to-white/80 rounded-xl border border-dimgray shadow-xl`}
    >
